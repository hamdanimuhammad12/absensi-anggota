...
<head>
    ...
    <style>
		...
		.bg-primary {
    background-color: #2d4ba9!important;
}
    </style>
</head>
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center justify-content-center" href="">
                <div class="sidebar-brand-icon">
                    <img style="max-width:50px;"  src="<?= base_url() ?>assets/img/avatar/logo_damkar.png" alt="" >
                </div>
                <div class="sidebar-brand-text mx-3"><font color="#333333"><b>Damkar</b></font></div>
            </a>
            ...
            <li class="nav-item <?=$this->uri->segment(1) == 'kelompok' || $this->uri->segment(1) == '' ? 'active"' : '' ?>">
                <a class="nav-link pb-0" href="<?= base_url('kelompok'); ?>">
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Absensi Anggota</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
